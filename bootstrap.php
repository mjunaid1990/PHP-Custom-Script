...
/* 
 * New file for custom php functions customfunctions.php
 * By Community Devs LLC
 */
require $_BASEPATH . 'GoogleTranslator.php';
require $_BASEPATH . 'customfunctions.php';
...
//$fr = 'upload/photos/2023/11/YKGi54mVzOaR5GKyKcae_full.png';
//if(is_readable($fr)) {
//    echo 'readable';
//}
//$handle = @fopen('upload/photos/2023/11/YKGi54mVzOaR5GKyKcae_full.png', 'r');
//if($handle === false) {
//    throw new \Exception("File not found: upload/photos/2023/11/YKGi54mVzOaR5GKyKcae_full.png", self::ERR_FILE_NOT_FOUND);
//}
//fclose($handle);
//die();
