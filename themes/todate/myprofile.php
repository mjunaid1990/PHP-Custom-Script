<?php
    ...
    $u = $db->where('id',$profile->id)->getOne('users');
    
    $profile_ID = get_user_uploaded_ID($profile->id);
...
<div class="container dt_user_profile_parent">
				...
				<div class="avatar">
					...
					<?php } else {?>
                                    <!--added by Community Devs LLC-->
                                        ...
                                        <?php 
                                        $is_profile_pic = is_profile_pic_approved($u['id'], $u['avater']);
                                        if($is_profile_pic) {
                                            ?>
    ...
    padding: 6px 20px;
    text-align: center;
    color: #67ac5b; cursor:pointer;"><?php echo __('Pending Approval');?></span>
						</a>
                                                    <?php
                                        }else {
                                            ?>
                                                <a class="dt_usr_undr_rvw">
                                                    <span onclick="document.getElementById('profileavatar_img').click(); return false" style="    line-height: 15px;
    padding: 6px 20px;
    text-align: center;
    color: #67ac5b; cursor:pointer;"><?php echo __('Add a photo to get discovered');?></span>
						</a>
                                                    <?php
                                        }
                                        ?>
	...
	<style>
        ...
        <div class="col s12 l7">
            <!--added by Community Devs LLC-->
            <?php if((int)$profile->profile_completion < 100) { ?>
            <div class="dt_user_profile dt_how_to_verfy_alrt">
                <a href="<?php echo $site_url;?>/settings/<?php echo $profile->username;?>">
                    
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#e18805" d="M12,1L3,5V11C3,16.55 6.84,21.74 12,23C17.16,21.74 21,16.55 21,11V5L12,1M17,15.59L15.59,17L12,13.41L8.41,17L7,15.59L10.59,12L7,8.41L8.41,7L12,10.59L15.59,7L17,8.41L13.41,12L17,15.59Z"></path></svg> 
            <?php echo __('Complete Your Profile To Earn'); ?> <?php echo $config->cost_per_profile_completion?$config->cost_per_profile_completion:0; ?> <?php echo __('Credits'); ?>
                </a>
            </div>
            <?php } ?>
                    ...
                    <div class="dt_user_profile dt_how_to_verfy_alrt">
						...
						<ul class="browser-default dt_prof_vrfy">
                            <?php if($config->emailValidation == "1"){?>
                                ...
                                <?php } ?>
                            <?php } ?>
                                        <!--modified by Community Devs LLC from 5 to 1-->
                                        
                                        <li><span class="circle-svg <?php echo $is_avatar_approved?'greens':''; ?>"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="122.881px" height="122.88px" viewBox="0 0 122.881 122.88" enable-background="new 0 0 122.881 122.88" xml:space="preserve"><g><path fill-rule="evenodd" clip-rule="evenodd" d="M61.44,0c33.933,0,61.441,27.507,61.441,61.439 c0,33.933-27.508,61.44-61.441,61.44C27.508,122.88,0,95.372,0,61.439C0,27.507,27.508,0,61.44,0L61.44,0z M34.106,67.678 l-0.015-0.014c-0.785-0.718-1.207-1.685-1.256-2.669c-0.049-0.982,0.275-1.985,0.984-2.777c0.01-0.011,0.019-0.021,0.029-0.031 c0.717-0.784,1.684-1.207,2.668-1.256c0.989-0.049,1.998,0.28,2.792,0.998l12.956,11.748l31.089-32.559v0 c0.74-0.776,1.723-1.18,2.719-1.204c0.992-0.025,1.994,0.329,2.771,1.067v0.001c0.777,0.739,1.18,1.724,1.205,2.718 c0.025,0.993-0.33,1.997-1.068,2.773L55.279,81.769c-0.023,0.024-0.048,0.047-0.073,0.067c-0.715,0.715-1.649,1.095-2.598,1.13 c-0.974,0.037-1.963-0.293-2.744-1L34.118,67.688L34.106,67.678L34.106,67.678L34.106,67.678z"/></g></svg></span><?php echo __( 'Upload at least 1 image.');?></li>
    
    <?php if($config->verification_on_signup == 1) { ?>
        <?php 
        $upload_text = __('Upload ID');
        if($profile_ID) {
            if($profile_ID['is_id_verification'] == 2) {
                ?>
                <li>
                    <span class="circle-svg greens"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="122.881px" height="122.88px" viewBox="0 0 122.881 122.88" enable-background="new 0 0 122.881 122.88" xml:space="preserve"><g><path fill-rule="evenodd" clip-rule="evenodd" d="M61.44,0c33.933,0,61.441,27.507,61.441,61.439 c0,33.933-27.508,61.44-61.441,61.44C27.508,122.88,0,95.372,0,61.439C0,27.507,27.508,0,61.44,0L61.44,0z M34.106,67.678 l-0.015-0.014c-0.785-0.718-1.207-1.685-1.256-2.669c-0.049-0.982,0.275-1.985,0.984-2.777c0.01-0.011,0.019-0.021,0.029-0.031 c0.717-0.784,1.684-1.207,2.668-1.256c0.989-0.049,1.998,0.28,2.792,0.998l12.956,11.748l31.089-32.559v0 c0.74-0.776,1.723-1.18,2.719-1.204c0.992-0.025,1.994,0.329,2.771,1.067v0.001c0.777,0.739,1.18,1.724,1.205,2.718 c0.025,0.993-0.33,1.997-1.068,2.773L55.279,81.769c-0.023,0.024-0.048,0.047-0.073,0.067c-0.715,0.715-1.649,1.095-2.598,1.13 c-0.974,0.037-1.963-0.293-2.744-1L34.118,67.688L34.106,67.678L34.106,67.678L34.106,67.678z"/></g></svg></span>
                    <?php echo trim($upload_text);?>
                    <span class="question-mark" title="You profile photo must match the same photo in the ID"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 122.88" style="enable-background:new 0 0 122.88 122.88" xml:space="preserve"><style type="text/css">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path class="st0" d="M122.88,61.44C122.88,27.51,95.37,0,61.44,0C27.51,0,0,27.51,0,61.44c0,33.93,27.51,61.44,61.44,61.44 C95.37,122.88,122.88,95.37,122.88,61.44L122.88,61.44z M68.79,74.58H51.3v-1.75c0-2.97,0.32-5.39,1-7.25 c0.68-1.87,1.68-3.55,3.01-5.1c1.34-1.54,4.35-4.23,9.01-8.11c2.48-2.03,3.73-3.88,3.73-5.56c0-1.71-0.51-3.01-1.5-3.95 c-1-0.93-2.51-1.4-4.54-1.4c-2.19,0-3.98,0.73-5.4,2.16c-1.43,1.44-2.34,3.97-2.74,7.56l-17.88-2.22c0.61-6.57,3-11.86,7.15-15.85 c4.17-4.02,10.55-6.01,19.14-6.01c6.7,0,12.1,1.4,16.21,4.19c5.6,3.78,8.38,8.82,8.38,15.1c0,2.62-0.73,5.14-2.16,7.56 c-1.44,2.44-4.39,5.39-8.85,8.88c-3.09,2.48-5.05,4.44-5.86,5.93C69.19,70.24,68.79,72.19,68.79,74.58L68.79,74.58z M50.68,79.25 h18.76v16.53H50.68V79.25L50.68,79.25z"/></g></svg></span>
                </li>
                <?php
            }else {
               ?>
                <li>
                    <span class="circle-svg  "><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="122.881px" height="122.88px" viewBox="0 0 122.881 122.88" enable-background="new 0 0 122.881 122.88" xml:space="preserve"><g><path fill-rule="evenodd" clip-rule="evenodd" d="M61.44,0c33.933,0,61.441,27.507,61.441,61.439 c0,33.933-27.508,61.44-61.441,61.44C27.508,122.88,0,95.372,0,61.439C0,27.507,27.508,0,61.44,0L61.44,0z M34.106,67.678 l-0.015-0.014c-0.785-0.718-1.207-1.685-1.256-2.669c-0.049-0.982,0.275-1.985,0.984-2.777c0.01-0.011,0.019-0.021,0.029-0.031 c0.717-0.784,1.684-1.207,2.668-1.256c0.989-0.049,1.998,0.28,2.792,0.998l12.956,11.748l31.089-32.559v0 c0.74-0.776,1.723-1.18,2.719-1.204c0.992-0.025,1.994,0.329,2.771,1.067v0.001c0.777,0.739,1.18,1.724,1.205,2.718 c0.025,0.993-0.33,1.997-1.068,2.773L55.279,81.769c-0.023,0.024-0.048,0.047-0.073,0.067c-0.715,0.715-1.649,1.095-2.598,1.13 c-0.974,0.037-1.963-0.293-2.744-1L34.118,67.688L34.106,67.678L34.106,67.678L34.106,67.678z"/></g></svg></span>
                    <?php echo trim($upload_text);?>
                    <span class="question-mark" title="You profile photo must match the same photo in the ID"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 122.88" style="enable-background:new 0 0 122.88 122.88" xml:space="preserve"><style type="text/css">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path class="st0" d="M122.88,61.44C122.88,27.51,95.37,0,61.44,0C27.51,0,0,27.51,0,61.44c0,33.93,27.51,61.44,61.44,61.44 C95.37,122.88,122.88,95.37,122.88,61.44L122.88,61.44z M68.79,74.58H51.3v-1.75c0-2.97,0.32-5.39,1-7.25 c0.68-1.87,1.68-3.55,3.01-5.1c1.34-1.54,4.35-4.23,9.01-8.11c2.48-2.03,3.73-3.88,3.73-5.56c0-1.71-0.51-3.01-1.5-3.95 c-1-0.93-2.51-1.4-4.54-1.4c-2.19,0-3.98,0.73-5.4,2.16c-1.43,1.44-2.34,3.97-2.74,7.56l-17.88-2.22c0.61-6.57,3-11.86,7.15-15.85 c4.17-4.02,10.55-6.01,19.14-6.01c6.7,0,12.1,1.4,16.21,4.19c5.6,3.78,8.38,8.82,8.38,15.1c0,2.62-0.73,5.14-2.16,7.56 c-1.44,2.44-4.39,5.39-8.85,8.88c-3.09,2.48-5.05,4.44-5.86,5.93C69.19,70.24,68.79,72.19,68.79,74.58L68.79,74.58z M50.68,79.25 h18.76v16.53H50.68V79.25L50.68,79.25z"/></g></svg></span>
                    <a href="javascript:void(0);" class="btn disabled" style="padding: 5px 10px;
    height: auto;
    line-height: initial;
    background-color: #e64980 !important;
    color: #fff !important;
    text-transform: capitalize;"><?php echo  __('Pending Review'); ?></a> 
                </li>
                <?php 
            }
        ?>                                
        ...
        <?php }else { ?>
            <li>
                ...
                <?php echo trim($upload_text);?>
                <span class="question-mark" title="You profile photo must match the same photo in the ID"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 122.88" style="enable-background:new 0 0 122.88 122.88" xml:space="preserve"><style type="text/css">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path class="st0" d="M122.88,61.44C122.88,27.51,95.37,0,61.44,0C27.51,0,0,27.51,0,61.44c0,33.93,27.51,61.44,61.44,61.44 C95.37,122.88,122.88,95.37,122.88,61.44L122.88,61.44z M68.79,74.58H51.3v-1.75c0-2.97,0.32-5.39,1-7.25 c0.68-1.87,1.68-3.55,3.01-5.1c1.34-1.54,4.35-4.23,9.01-8.11c2.48-2.03,3.73-3.88,3.73-5.56c0-1.71-0.51-3.01-1.5-3.95 c-1-0.93-2.51-1.4-4.54-1.4c-2.19,0-3.98,0.73-5.4,2.16c-1.43,1.44-2.34,3.97-2.74,7.56l-17.88-2.22c0.61-6.57,3-11.86,7.15-15.85 c4.17-4.02,10.55-6.01,19.14-6.01c6.7,0,12.1,1.4,16.21,4.19c5.6,3.78,8.38,8.82,8.38,15.1c0,2.62-0.73,5.14-2.16,7.56 c-1.44,2.44-4.39,5.39-8.85,8.88c-3.09,2.48-5.05,4.44-5.86,5.93C69.19,70.24,68.79,72.19,68.79,74.58L68.79,74.58z M50.68,79.25 h18.76v16.53H50.68V79.25L50.68,79.25z"/></g></svg></span>
                <a href="javascript:void(0);" class="btn btn-upload-doc"><?php echo  __('Verify Now'); ?></a> 
            </li>
        <?php } ?>
    <?php } ?>
                                        ...
                                        <li>
                                            <span class="circle-svg"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="122.881px" height="122.88px" viewBox="0 0 122.881 122.88" enable-background="new 0 0 122.881 122.88" xml:space="preserve"><g><path fill-rule="evenodd" clip-rule="evenodd" d="M61.44,0c33.933,0,61.441,27.507,61.441,61.439 c0,33.933-27.508,61.44-61.441,61.44C27.508,122.88,0,95.372,0,61.439C0,27.507,27.508,0,61.44,0L61.44,0z M34.106,67.678 l-0.015-0.014c-0.785-0.718-1.207-1.685-1.256-2.669c-0.049-0.982,0.275-1.985,0.984-2.777c0.01-0.011,0.019-0.021,0.029-0.031 c0.717-0.784,1.684-1.207,2.668-1.256c0.989-0.049,1.998,0.28,2.792,0.998l12.956,11.748l31.089-32.559v0 c0.74-0.776,1.723-1.18,2.719-1.204c0.992-0.025,1.994,0.329,2.771,1.067v0.001c0.777,0.739,1.18,1.724,1.205,2.718 c0.025,0.993-0.33,1.997-1.068,2.773L55.279,81.769c-0.023,0.024-0.048,0.047-0.073,0.067c-0.715,0.715-1.649,1.095-2.598,1.13 c-0.974,0.037-1.963-0.293-2.744-1L34.118,67.688L34.106,67.678L34.106,67.678L34.106,67.678z"/></g></svg></span>
                                            <?php echo __('Earn').' '. $config->users_earn_from_verification.' '.__('Credits');?>
                                        </li>
					...
					<div class="combo">
						<h2><?php echo $profile->full_name.$profile->pro_icon;?><?php echo ( $profile->age  > 0 ) ? ", ". $profile->age : "";?>
							...
							<?php } ?>
                                            ...
                                            <?php
//                                            profile header add by Community Devs LLC
                                            $profile_header = UserFieldsDataByID($profile->id, 48);
                                            if($profile_header) {
                                                echo '<h5 style="margin: 0;
    font-size: 15px;">'.$profile_header.'</h5>';
                                            }
...
<!--                                        added href url
                                        ...
                                        <a class="dt_user_prof_complt" style="display: block;" href="<?php echo $site_url;?>/settings/<?php echo $profile->username;?>">
				...
				<?php if( !empty( $profile->location ) ) {?>
					<div class="to_usr_info_block">
						<h5><?php echo __( 'Location' );?></h5>
                                                <!--location is replaced to incomplete address by Community Devs LLC-->
                                                <?php
                                                $verified_svg = '<svg enable-background="new 0 0 2039.9 2500" viewBox="0 0 2039.9 2500" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="m1991.4 503.9-942 1934.3-1001.9-1284.1z" fill="#fff" fill-rule="evenodd"></path><path d="m1019.9 0-1019.9 453.3v680c0 632.3 437.4 1223.9 1019.9 1366.7 588.2-143.9 1019.9-734.4 1019.9-1366.7v-680zm-226.6 1822.3-453.3-453.3 160.9-160.9 294.6 293.5 748-755.9 160.9 162.1z" fill="#4285f4"></path></svg>';
                                                ?>
                                                <style>
                                                    .verified-loc-badge {
                                                        margin-right: 5px;
                                                    }
                                                    .verified-loc-badge svg {
                                                        width: 16px;
                                                        margin-top: -4px;
                                                    }
                                                    .verified-loc-badge svg path:last-child {
                                                        fill: #42a446;
                                                    }
                                                </style>
                                                <p class="to_intrst_des"><?php echo $profile->is_location_verified?'<span class="verified-loc-badge" title="'.__('Verified Location').'">'.$verified_svg.'</span>':''; ?><?php echo GetProfileLocation($profile);?></p>
						<div class="to_location_map">
                                                    <?php 
                                                    $plc = urlencode(GetProfileLocationUrl($profile));
                                                    $plc2 = urlencode(GetProfileLocationUrl2($profile));
                                                    $loc = 'https://maps.googleapis.com/maps/api/staticmap?center='.$plc2.'&zoom=13&size=600x205&maptype=roadmap&key='.$config->google_place_api; 
                                                    ?>
                                                    <?php if($profile->country_id == 2331) { ?>
                                                    <img src="<?php echo $theme_url; ?>assets/img/Palestine-Map.jpg" alt="<?php echo __( 'Location' );?>" />
                                                    <?php }else { ?>
                                                    <img src="<?php echo $loc; ?>" alt="<?php echo __( 'Location' );?>" />
                                                    <?php } ?>
				...
				<?php if( !empty( $profile->about ) ) {?>
					<div class="to_usr_info_block">
						<h5><?php echo __( 'About' );?></h5>
                                                <div><p class="to_intrst_des para-read-more-about" data-controller="#readMoreAbout" style="margin-bottom:0;"><?php echo nl2br($profile->about);?></p><a id="readMoreAbout" style="color:#e64980;">Read more</a></div>
					</div>
				<?php } ?>
...
//                                        if avatar exist otherwise show full image
//                                            by Community Devs LLC
				...
				<div class="to_usr_info_block to_usr_info_things">
					...
					<div class="dt_profile_info">
						...
						<?php
                                                        ...
                                                        $general_fields = GetProfileFieldsByLocationTypeByIds('general', '1,11,12');
							$general_custom_data = UserFieldsData($profile->id);
							if (count($general_fields) > 0) {
								foreach ($general_fields as $key => $field) {
									if($field['profile_page'] == 1) {
//                                                                            hide if have childern is selected as no
//                                                                                            by Community Devs LLC
											...
											$hide = 'hide';
                                                                                        if ($field['select_type'] == 'yes') {
                                                                                            ...
                                                                                            if (isset($options[$general_custom_data[$field['fid']]])) {
                                                                                                $hide = '';
                                                                                            }else if($general_custom_data[$field['fid']]) {
                                                                                                $hide = '';
                                                                                            }
                                                                                        }else {
                                                                                            if($general_custom_data[$field['fid']]) {
                                                                                                $hide = '';
                                                                                            }
                                                                                        }
                                                                                    
											echo '<div class="row '.$hide.' '.$field['fid'].'">';
...
//                                                                                                end by Community Devs LLC
							...
							$general_fields = GetProfileFieldsByLocationType('profile', 'Under Profile', null, 48);
							$general_custom_data = UserFieldsData($profile->id);
							if (count($general_fields) > 0) {
								foreach ($general_fields as $key => $field) {
                                                                        
									if($field['profile_page'] == 1) {
										if( isset($field['fid']) &&  isset($general_custom_data[$field['fid']]) && $general_custom_data[$field['fid']] !== null ) {
                                                                                        $hide = 'hide';
                                                                                        if ($field['select_type'] == 'yes') {
                                                                                            if($field['fid'] != 'fid_11') {
                                                                                                $options = @explode(',', $field['type']);
						...
						?>
                                        ...
                                        <!--added by Community Devs LLC-->
                                        <?php
                                        $general_fields = GetProfileFieldsByLocationTypeByIds('general', '27,28,29,30,31');
                                        $general_custom_data = UserFieldsData($profile->id);
					$display = false;
                                        if (count($general_fields) > 0) {
                                                foreach ($general_fields as $key => $field) {
                                                        if($field['profile_page'] == 1) {
                                                                if( isset($general_custom_data[$field['fid']]) && !empty($general_custom_data[$field['fid']]) ) {
                                                                    $display = true;
                                                                }
                                                        }
                                                }
                                        ...
                                        ?>
                                        <div class="dt_profile_info">
                                            <h5><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M20 22h-2v-2a3 3 0 0 0-3-3H9a3 3 0 0 0-3 3v2H4v-2a5 5 0 0 1 5-5h6a5 5 0 0 1 5 5v2zm-8-9a6 6 0 1 1 0-12 6 6 0 0 1 0 12zm0-2a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" fill="currentColor"></path></svg> <?php echo __( 'Proposal' );?></h5>
                                            <?php
							$general_fields = GetProfileFieldsByLocationTypeByIds('general', '27,28,29,30,31');
							$general_custom_data = UserFieldsData($profile->id);
							if (count($general_fields) > 0) {
								foreach ($general_fields as $key => $field) {
                                                                        ...
                                                                        $read_more = '';
                                                                        if($field['fid'] == 'fid_28') {
                                                                            $read_more_cls = 'para-read-more2';
                                                                            $d_contr = '#readMore2';
                                                                            $read_more = '<a id="readMore2" style="color:#e64980;">Read more</a>';
                                                                        }
									if($field['profile_page'] == 1) {
										if( isset($field['fid']) &&  isset($general_custom_data[$field['fid']]) && $general_custom_data[$field['fid']] !== null ) {
											...
											if ($field['select_type'] == 'yes') {
												...
												if($field['fid'] == 'fid_28') {
                                                                                                    echo '<div class="col s6 m7"><p class="'.$read_more_cls.'" data-controller="'.$d_contr.'" style="white-space: pre-wrap;">' . breaktonewline($general_custom_data[$field['fid']]).'</p>'.$read_more.'</div>';
                                                                                                }else {
                                                                                                    echo '<div class="col s6 m7"><p>' . $general_custom_data[$field['fid']] . '</p></div>';
                                                                                                }
											}
						...
						?>
                                        ...
                                        <!--end by Community Devs LLC-->
                                        <?php
                                        $general_fields = GetProfileFieldsByLocationTypeByIds('profile', '22');
                                        $general_custom_data = UserFieldsData($profile->id);
					$display = false;
                                        if (count($general_fields) > 0) {
                                                foreach ($general_fields as $key => $field) {
                                        ...
                                        ?>
					<div class="dt_profile_info <?php echo $display == false?'hide':''; ?>">
						...
						<?php } ?>
                                                <!--added by Community Devs LLC-->
                                                <?php //display weight, hair type and hair length field
							$general_fields = GetProfileFieldsByLocationTypeByIds('profile', "17,19,18");
							$general_custom_data = UserFieldsData($profile->id);
							if (count($general_fields) > 0) {
								foreach ($general_fields as $key => $field) {
						...
						<?php } ?>
                                                ...
                                                <?php
                                                $idx = '20,23,24,25';
                                                if($profile->gender == 4526) {
                                                    $idx = '21,23,24,25';
                                                }
                                                //display beared style, eye color, eye wear, apearance considered as
                                                $general_fields = GetProfileFieldsByLocationTypeByIds('profile', $idx);
                                                $general_custom_data = UserFieldsData($profile->id);
                                                if (count($general_fields) > 0) {
                                                        foreach ($general_fields as $key => $field) {
						...
						<?php //display physical health status field
							$general_fields = GetProfileFieldsByLocationTypeByIds('profile', '26');
							$general_custom_data = UserFieldsData($profile->id);
							if (count($general_fields) > 0) {
								foreach ($general_fields as $key => $field) {
						...
						?> 
                                                ...
                                                <?php //display all fields dynamically which comes under this cateogory
							$general_fields = GetProfileFieldsByLocationType('profile', 'Under Looks', null, '48,13,16,22,17,19,18,20,21,23,24,25,26');
							$general_custom_data = UserFieldsData($profile->id);
							if (count($general_fields) > 0) {
								foreach ($general_fields as $key => $field) {
						...
						?> 
                                        ...
                                        <!--added by Community Devs LLC-->
                                        <?php
                                        $general_fields = GetProfileFieldsByLocationTypeDynamic('profile', 'Under Personality');
                                        $general_custom_data = UserFieldsData($profile->id);
					$display = false;
                                        if (count($general_fields) > 0) {
                                                foreach ($general_fields as $key => $field) {
					...
					<div class="dt_profile_info <?php echo $display == false?'hide':''; ?>">
						...
						<?php } ?>
                                                 <!--added by Community Devs LLC-->       
                                                <?php //display all fields dynamically which comes under personality
							
							if (count($general_fields) > 0) {
								foreach ($general_fields as $key => $field) {
                                                                        if($profile->children == '1') {
                                                                            if( isset($field['fid']) && $field['fid'] == 'fid_37') {
                                                                                unset($field['fid']);
                                                                            }
                                                                            if( isset($field['fid']) && $field['fid'] == 'fid_38') {
                                                                                unset($field['fid']);
                                                                            }
                                                                            if( isset($field['fid']) && $field['fid'] == 'fid_39') {
                                                                                unset($field['fid']);
                                                                            }
                                                                        }
									if($field['profile_page'] == 1) {
						...
						<?php } ?>
                                        ...
                                        <!--added by Community Devs LLC-->
                                        <?php
                                        $general_fields = GetProfileFieldsByLocationTypeDynamic('profile', 'Under Lifestyle');
                                        $general_custom_data = UserFieldsData($profile->id);
					$display = false;
                                        if (count($general_fields) > 0) {
                                                foreach ($general_fields as $key => $field) {
					...
					<div class="dt_profile_info <?php echo $display == false?'hide':''; ?>">
							...
							<h5><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M13 2.05c5.053.501 9 4.765 9 9.95v1h-9v6a2 2 0 1 0 4 0v-1h2v1a4 4 0 1 1-8 0v-6H2v-1c0-5.185 3.947-9.449 9-9.95V2a1 1 0 0 1 2 0v.05zM19.938 11a8.001 8.001 0 0 0-15.876 0h15.876z" fill="currentColor"></path></svg> <?php echo __( 'Lifestyle' );?></h5>
                                                ...
                                                <?php //display all fields dynamically which comes under lifesytle
					...
					<?php
                                        ...
                                        ?>
                                        <!--added and modified by Community Devs LLC-->
					<div class="dt_profile_info <?php echo $display == false?'hide':''; ?>">
							...
							<h5><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M12 22l-9.192-9.192c-2.18-2.568-2.066-6.42.353-8.84A6.5 6.5 0 0 1 12 3.64a6.5 6.5 0 0 1 9.179 9.154L12 22zm7.662-10.509a4.5 4.5 0 0 0-6.355-6.337L12 6.282l-1.307-1.128a4.5 4.5 0 0 0-6.355 6.337l.114.132L12 19.172l7.548-7.549.114-.132z" fill="currentColor"></path></svg> <?php echo __( 'Favourites' );?></h5>
                                                ...
                                                <?php //display all fields dynamically which comes under lifesytle
							$general_fields = GetProfileFieldsByLocationTypeDynamic('profile', 'Under Favourites');
							$general_custom_data = UserFieldsData($profile->id);
                                                        if (count($general_fields) > 0) {
								foreach ($general_fields as $key => $field) {
                                                                        if($field['fid'] == 'fid_48') {
                                                                        ...
                                                                        $read_more = '';
                                                                        if($field['fid'] == 'fid_44') {
                                                                            $read_more_cls = 'para-read-more';
                                                                            $d_contr = '#readMore';
                                                                            $read_more = '<a id="readMore" style="color:#e64980;">Read more</a>';
                                                                        }
//									if($field['profile_page'] == 1) {
										if( isset($field['fid']) &&  isset($general_custom_data[$field['fid']]) && $general_custom_data[$field['fid']] !== null ) {
											$hide = 'hide';
