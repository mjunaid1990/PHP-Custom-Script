			...
			<div class="to_step_innr">
				<div class="slider-ctr">
					<div class="slider">
						...
						<?php } else { ?>
                            <form class="slider-form slider-one" id="verification_on_signup" style="padding: 20px 5px;">
						...
						<form class="slider-form slider-two">
                                                    <div class="row r_margin">
                                                        <div class="col s12">
                                                            <h4 style="color: #42a446;
    font-size: 20px;"><?php echo __( "Let's build your professional network" );?></h4>
                                                        </div>
                                                    </div>
							<div class="row r_margin">
								<div class="col s6">
