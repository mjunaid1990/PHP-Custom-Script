...
<div class="govt_doc_modal modal" id="govt_doc_modal">
    <div class="modal-content">
            <h4><?php echo __('Upload ID');?></h4>
            <div class="modal-body ">
                <p><?php echo __('Your photo must match the photo in the ID') ?></p>
                <div class="form-group" style="min-height: 70px;">
                    ...
                    <input id="attachment-id" name="attachment_id" type="file" class="browser-default hide">
                    <label for="attachment-id" id="file-chosen" style="cursor: pointer;background: #fff;padding: 5px 10px;color: #222;border-radius: 4px;"><?php echo  __('Choose File'); ?></label>
                </div>

            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-main" id="btn-submit-id"><?php echo __( 'Submit' );?></button>
                <button type="button" class="btn btn-outline-secondary" onclick="CloseModal('#govt_doc_modal')"><?php echo __( 'Cancel' );?></button>
            </div>
    </div>
</div>
<?php } ?>

<!--add by Community Devs LLC regarding trex-->

<div class="new_message_trex_modal modal" id="new_message_trex_modal">
    <div class="modal-content">
            <h4>🌟 <?php echo __('Ready to Connect?');?></h4>
            <div class="modal-body ">
                <p>
                    <?php echo sprintf(__("We're excited to see you taking the next step to Halal! Just a heads up:
Initiating a connection requires %d Trex per new user.
This helps us maintain a high-quality experience for everyone, and ensure each interaction is meaningful."), $config->new_message_trex_cost) ?></p>
                
                <p>Your Current Balance: <strong><?= auth()->balance; ?></strong></p>
                <a href="/page/Trex" target="_blank" style="color: rgb(230, 73, 128); display: block;">Trex Coin</a>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-main" id="btn_new_private_conversation" ><?php echo __( 'Proceed' );?></button>
                <button type="button" class="btn btn-transparent" onclick="CloseModal('#new_message_trex_modal')"><?php echo __( 'Not Now' );?></button>
...
<div class="reward_modal modal" id="profile_complete_modal">
    <div class="modal-content dt_bank_trans_modal">
            ...
            <div class="modal-body credit_pln">
                    ...
                    <p style="text-align: center;"><?php echo __( 'Congratulations!. you have earned' );?> <?php echo (int)$config->cost_per_profile_completion;?> <?php echo __( 'credits' );?></p>
            </div>
    </div>
</div>
        ...
        <div class="payment_modal modal" id="reward_daily_credit_modal">
            <div class="modal-content dt_bank_trans_modal" style="text-align: center;">
				<h4><?php echo __('Credit Reward');?></h4>
				<div class="modal-body credit_pln">
                                    <img src="<?php echo $theme_url;?>assets/img/credits/bag.png" alt="<?php echo __( 'Bag of Credits' );?>" width="80" height="80" style="margin:20px;"/>
				
                                    <p style="display: inline-block;"><span style="color:#42a446"><?php echo __( 'Congratulation! ' );?></span> <?php echo __( 'you earned ' );?> <?php echo (int)$config->credit_earn_day_amount;?> <?php echo __( ' credits for the daily login ' ) ;?></p>
                                    <p class="to_mat_input_switch switch no_margin_top" title="<?php echo __('By clicking here, you will not see this popup in future.') ?>" style="max-width: 250px; margin: 0 auto;">
                                            <label style="flex-direction: row;">
                                                <?php echo __( "Don't show again" );?>
                                                <input type="checkbox" name="show_daily_credit_popup" id="show_daily_credit_popup">
        ...
        <?php if($config->isDailyCredit){ ?>
            <script>
                $(document).ready(function() {
                    setTimeout(function() { // modified by Community Devs LLC
