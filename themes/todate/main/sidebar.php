	...
	<div class="to_side_menus">
		...
		<ul class="home_usr_link">
			...
			<li class="dis <?php if($data['name'] == 'disliked'){ echo 'active';}?>">
				<a href="<?php echo $site_url;?>/passed" data-ajax="/passed">
			...
			<li class="blg <?php if($data['name'] == 'blog'){ echo 'active';}?>">
				<a href="<?php echo $site_url;?>/blogs" data-ajax="/blogs"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M19 22H5a3 3 0 0 1-3-3V3a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v12h4v4a3 3 0 0 1-3 3zm-1-5v2a1 1 0 0 0 2 0v-2h-2zm-2 3V4H4v15a1 1 0 0 0 1 1h11zM6 7h8v2H6V7zm0 4h8v2H6v-2zm0 4h5v2H6v-2z" fill="currentColor"/><path d="M19 22H5a3 3 0 0 1-3-3V3a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v12h4v4a3 3 0 0 1-3 3zm-1-5v2a1 1 0 0 0 2 0v-2h-2zM6 7v2h8V7H6zm0 4v2h8v-2H6zm0 4v2h5v-2H6z" class="active_path" fill="currentColor"/></svg> <?php echo __( 'Blogs' );?></a>
			</li>
			<?php if ($config->agora_live_video == 1) { ?>
