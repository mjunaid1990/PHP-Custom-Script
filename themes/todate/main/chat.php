                        ...
                        <div class="chat_f_text">
                            ...
                            <form method="POST" action="/chat/send_message" class="valign-wrapper" id="chat_message_form">
                                ...
                                <div class="chat_f_send">
                                    <a class="btn-floating btn-large waves-light modal-trigger hide" href="#new_message_trex_modal" data-auth="<?= auth()->id; ?>" data-to="<?= $profile->id ?>" id="btn_confirm_private_conversation">
                                    ...
                                    <button type="button" id="btn_chat_f_send" class="btn-floating btn-large waves-light hide"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M2,21L23,12L2,3V10L17,12L2,14V21Z" /></svg></button>
                                </div>
                            </form>
							<!-- Stickers -->
