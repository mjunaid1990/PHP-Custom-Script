	...
	<div class="dt_premium dt_sections">
		...
		<div class="dt_choose_pro">
			...
			<div class="valign-wrapper dt_pro_plans">
					...
					<label>
						...
						<span class="pln_name">
							...
							<span class="duration"><?php echo __( 'Weekly' );?></span>
                                                        <span class="trex-bonus" style="font-size: 12px; margin-top: 5px; color: #ccc;">Trex Bonus: <?php echo $config->weekly_pro_plan_trex_bonus;?></span>
				...
				<div>
					<label>
						<input class="with-gap" name="pro_plan" type="radio" value="<?php echo __( 'Monthly' );?>" data-price="<?php echo (float)$config->monthly_pro_plan;?>"  />
						<span class="pln_name">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="m21.28 4.473c-.848-.721-2.109-.604-2.817.262l-8.849 10.835-4.504-3.064c-.918-.626-2.161-.372-2.773.566s-.364 2.205.555 2.83l7.494 5.098 11.151-13.653c.707-.866.592-2.152-.257-2.874z" /></svg>
							<span class="duration"><?php echo __( 'Monthly' );?></span>
                                                        <span class="trex-bonus" style="font-size: 12px; margin-top: 5px; color: #ccc;">Trex Bonus: <?php echo $config->monthly_pro_plan_trex_bonus;?></span>
				...
				<div>
					<label>
						<input class="with-gap" name="pro_plan" type="radio" value="<?php echo __( 'Yearly' );?>" data-price="<?php echo (float)$config->yearly_pro_plan;?>" checked />
						<span class="pln_name">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="m21.28 4.473c-.848-.721-2.109-.604-2.817.262l-8.849 10.835-4.504-3.064c-.918-.626-2.161-.372-2.773.566s-.364 2.205.555 2.83l7.494 5.098 11.151-13.653c.707-.866.592-2.152-.257-2.874z" /></svg>
                                                        <span class="duration"><?php echo __( '3 Months' );?></span><!-- modified by Community Devs LLC -->
                                                        <span class="trex-bonus" style="font-size: 12px; margin-top: 5px; color: #ccc;">Trex Bonus: <?php echo $config->yearly_pro_plan_trex_bonus;?></span>
				...
				<div>
					<label>
						...
						<span class="pln_name">
							...
							<span class="trex-bonus" style="font-size: 12px; margin-top: 5px; color: #ccc;">Trex Bonus: <?php echo $config->lifetime_pro_plan_trex_bonus;?></span>
...
//                modified by Community Devs LLC
                if(plans[index].value == 'Yearly') {
                    return '3 Months';
                }
                if(plans[index].value == 'Lifetime') {
                    return 'Yearly';
                }
