...
<div class="container dt_terms">
    <div class="row">
        ...
        <div class="col s12 m8 l9">
            <h1 class="bold"><?php echo __( 'Developers' );?> <a class="btn btn_primary waves-effect waves-light btn-flat btn-small white-text" data-ajax="/create-app" href="<?php echo $site_url;?>/create-app"><?php echo __( 'Create App' ) ?></a> <a class="btn btn_primary waves-effect waves-light btn-flat btn-small white-text" data-ajax="/apps" href="<?php echo $site_url;?>/apps"><?php echo __( 'My Apps' ) ?></a></h1>
