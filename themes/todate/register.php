<div class="to_auth_page register">
	<div class="login_page">
		<div class="header_logo">
			<a id="logo-container" href="<?php echo $site_url;?>/" class="brand-logo"><img src="<?php echo $theme_url;?>assets/img/logo.png" alt="Queen Muslima Logo" /></a>
		</div>
					...
					<div class="row r_margin mb-0">
						<div class="col s6 xs12">
							<div class="to_mat_input">
								<input name="first_name" id="first_name" type="text" class="browser-default" placeholder="<?php echo __( 'Safe Name' );?>" required autofocus>
