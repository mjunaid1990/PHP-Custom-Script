...
<div class="row to_sett_row">
	...
	<div class="col m12 l8">
		<div class="dt_settings dt_usr_affl">
			<h2 class="user_sttng_panel_hd"><?php echo __('My balance');?>: <?php echo $config->currency_symbol;?><?php echo $user->aff_balance?number_format($user->aff_balance, 2):'0.00';?></h2>
			<div class="delete_acc">
                ...
                <hr class="border_hr">
                        ...
                        <img src="<?php echo $theme_url;?>assets/img/Referral-Marketing-Queen-Muslima.png" alt="<?php echo __( 'My affiliates' );?>" style="width: auto !important;">
			...
			<?php } ?>
			<hr class="border_hr">
                        <div class="alert alert-success copied" role="alert" style="display:none;"><?php echo __('Copied') ?></div>
			<div class="row">
				<div class="col l4"><?php echo __('Your affiliate link is');?></div>
				<div class="col l8">
                                    <!--modified by Community Devs LLC-->
                                        
                                    <div class="input-field input-night" title="<?php echo __('Copy to clipboard'); ?>">
                                                
						<input type="text" readonly onclick="this.select();" value="<?php echo $site_url;?>/register?ref=<?php echo $user->username;?>" class="copy-link">
					</div>
				</div>
			</div>
			<div class="row">
			...
			<div class="dt_usr_referres">
                            ...
                            <!--modified by Community Devs LLC-->
                            <?php $refs = Wo_GetReferrers(); ?>
                            <?php if($refs) { ?>
                            <h5><?php echo __('My Referral List'); ?></h5>
                ...
                <?php
                                        foreach ($refs as $key => $wo['ref']) {
                                            $ref = GetRefferralUserPayment($wo['ref']['id'], $wo['ref']['referrer'])
                                            ?>
                                            <tr>
							...
							<img src="<?php echo GetMedia($wo['ref']['avater']);?>" alt="Image">
                                                    ...
                                                    <div class="name">
                                                            <a href="javascript:void(0);"><?php echo $wo['ref']['first_name'] . ' ' . $wo['ref']['last_name'];?><br></a>
                                                            <div class="joined"><?php echo __('joined'); ?>: <?php echo Time_Elapsed_String($wo['ref']['registered']);?></div>
                                                    </div>
                                                </td>
                                                <td><?php echo $ref?$ref['amount']:'';?></td>
                                                <td><?php echo $ref?__('Yes'):'No';?></td>
