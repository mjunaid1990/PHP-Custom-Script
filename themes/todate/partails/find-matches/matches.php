		...
		<div class="col l6 m12 s12 xs12">
			<div class="valign-wrapper hotnot_info">
				...
				<div class="usr_name">
					...
					?>
					<a href="<?php echo $site_url;?>/@<?php echo $matche->username;?>" data-ajax="/@<?php echo $matche->username;?>"><?php echo ($matche->first_name !== '' ) ? $matche->first_name : $matche->username;?></a> <?php if( !empty($_age) ) {?><span class="usr_age"><?php echo $_age;?></span><?php }?>
				</div>
