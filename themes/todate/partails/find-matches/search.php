		...
		<div class="card-image">
			...
			<div class="card-content">
				<div class="card-content-info">
					...
					<h3><a href="<?php echo $site_url;?>/@<?php echo $row->username;?>" data-ajax="/@<?php echo $row->username;?>"><?php echo ($row->first_name !== '' ) ? $row->first_name : $row->username;?></a> <?php if((int)abs(((strtotime(date('Y-m-d H:i:s')) - $row->lastseen))) < 60) { echo '<div class="useronline"></div>'; }?></h3>
