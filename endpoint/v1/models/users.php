...
//        updated by Community Devs LLC
        $user['incomplete_address'] = '';
        $user['filter_profile_setting_words'] = '';
        $user['filter_general_setting_words'] = '';
        $user['your_partner'] = '';
        $user['activities_after_marriage'] = '';
        $user['time_share'] = '';
        $user['activities_feeling_stressed'] = '';
        $user['qualities'] = '';
        $user['last_step'] = '';
        $user['character'] = isset($data['character'])?implode(',', $data['character']):'';
        
//        enable default email notifications
        $user['email_on_new_message'] = 1;
        $user['email_on_profile_like'] = 1;
        $user['email_on_purchase_notifications'] = 1;
        
        $user['privacy_show_profile_on_google'] = 0;
        $user['email_on_profile_view'] = 0;
        $user['email_on_special_offers'] = 1;
        $user['email_on_announcements'] = 1;
        
        $user['profile_completed'] = 0;
        $user['show_daily_credit_popup'] = 0;
        ...
        if (isset($_POST['ref']) && !empty($_POST['ref'])) { //modified by Community Devs LLC
